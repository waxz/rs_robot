...
impl LoopHelperBuilder
{
    ...
    {
        self.build_with_target_rate(f64::INFINITY, 1000_000)
    }
    ...
    ) -> LoopHelper
    {
        ...
        LoopHelper {
            ...
            sleeper: SpinSleeper::new(SubsecondNanoseconds::from(native_accuracy))
                .with_spin_strategy(SpinStrategy::SpinLoopHint),
            // sleeper:  SpinSleeper::new(500_000).with_spin_strategy(SpinStrategy::YieldThread) ,
            // sleeper:  SpinSleeper::new(800_000).with_spin_strategy(SpinStrategy::SpinLoopHint) ,
            last_report: now,
            last_loop_start: now,
